...
| `openjdk-11` `openjdk-11-20221117` `openjdk-11.0` `openjdk-11.0.17` `openjdk-11.0.17.8` `openjdk-11.0.17.8-r1` | `sha256:45aebacce34ac0baebab7e39fe2e57b727631d7899fda0443bd6d87349764a75`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:45aebacce34ac0baebab7e39fe2e57b727631d7899fda0443bd6d87349764a75) | `amd64` |
...
| `openjdk-jre-17` `openjdk-jre-17-20221117` `openjdk-jre-17.0` `openjdk-jre-17.0.5` `openjdk-jre-17.0.5.8` `openjdk-jre-17.0.5.8-r1` | `sha256:d38f37be8cd6bc08bdaf2f8e45893c6eb4fc3c8aa85db41fd062940fa3858d71`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:d38f37be8cd6bc08bdaf2f8e45893c6eb4fc3c8aa85db41fd062940fa3858d71) | `amd64` |
...
| `openjdk-jre-11` `openjdk-jre-11-20221117` `openjdk-jre-11.0` `openjdk-jre-11.0.17` `openjdk-jre-11.0.17.8` `openjdk-jre-11.0.17.8-r1` | `sha256:55dc60c3ca309115559545038761bb150dd620eadec4264449e0e1d9549b5d18`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:55dc60c3ca309115559545038761bb150dd620eadec4264449e0e1d9549b5d18) | `amd64` |
...
| `latest` `openjdk-17` `openjdk-17-20221117` `openjdk-17.0` `openjdk-17.0.5` `openjdk-17.0.5.8` `openjdk-17.0.5.8-r1` | `sha256:b9a3f4fca108eb7b333dd339a9e19dfe22ea79da9ffdce711ceb293ba2d2a6dc`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:b9a3f4fca108eb7b333dd339a9e19dfe22ea79da9ffdce711ceb293ba2d2a6dc) | `amd64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:b9a3f4fca108eb7b333dd339a9e19dfe22ea79da9ffdce711ceb293ba2d2a6dc"
      },
    ...
    "optional": {
      ...
      "1.3.6.1.4.1.57264.1.3": "694062ace0c07919011b75d3f58a50c7e82ca373",
      "1.3.6.1.4.1.57264.1.4": ".github/workflows/release.yaml",
      "1.3.6.1.4.1.57264.1.5": "chainguard-images/images",
      "1.3.6.1.4.1.57264.1.6": "refs/heads/vuln-scan",
      "Bundle": {
        "SignedEntryTimestamp": "MEQCIA06WtLi9B4TC8NbmhHAkC7OvmEGtuivIbiLAFkKfzAgAiAq7J0VQMzJFXY+3Cr/n2gpHGMSo3km7i5fS3LGE+hnyw==",
        "Payload": {
          "body": "",
          "integratedTime": 1668643368,
          "logIndex": 7236935,
          "logID": "c0d23d6ad406973f9559f3ba2d1ca01f84147d8ffc5b8445c224f98b9591801d"
        }
      },
      "Issuer": "https://token.actions.githubusercontent.com",
      "Subject": "https://github.com/chainguard-images/images/.github/workflows/release.yaml@refs/heads/vuln-scan",
      "githubWorkflowName": ".github/workflows/release.yaml",
      "githubWorkflowRef": "refs/heads/vuln-scan",
      "githubWorkflowRepository": "chainguard-images/images",
      "githubWorkflowSha": "694062ace0c07919011b75d3f58a50c7e82ca373",
      "githubWorkflowTrigger": "push",
      "run_attempt": "1",
      "run_id": "3484133523",
      "sha": "694062ace0c07919011b75d3f58a50c7e82ca373"
    }
  }
]
```
